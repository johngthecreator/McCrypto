...
function Nav(props) {
    ...
    return (
        ...
        className='border-solid border-[#ea00d9] border-2 rounded-xl shadow-xl overflow-scroll'>
            ...
            <div className="grid grid-columns-1 w-full">
                <button className="text-center font-extrabold text-[#ea00d9] hover:text-white duration-200 text-xl px-5 py-2" onClick={()=>{navigate("/")}} >Home</button>
                <button className="text-center font-extrabold text-[#ea00d9] hover:text-white duration-200 text-xl px-5 py-2" onClick={()=>{navigate("/crypto")}} >Crypto</button>
            </div>
            </DrawerBody>
        </DrawerContent>
        </Drawer>
